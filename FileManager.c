...
/* キー情報 */
static uint8_t	g_ubFileManagerGetKey[2];
...
uint8_t	GetKeyInfo(int16_t);
uint8_t	SetKeyInfo(int16_t, uint8_t);
...
#if 0
			if(GetKeyInfo(0) == 0x01u)	/* ESC */
			{
				SetKeyInfo(0, 0);
				break;
			}
			if(GetKeyInfo(1) == 0x11u)	/* Q */
			{
				SetKeyInfo(1, 0);
				break;
			}
...
/* 機能		:	*/
/*===========================================================================================*/
uint8_t	GetKeyInfo(int16_t nNum)
{
	uint8_t ret = 0;
	
	ret = g_ubFileManagerGetKey[nNum];
...
/* 機能		:	*/
/*===========================================================================================*/
uint8_t	SetKeyInfo(int16_t nNum, uint8_t ubKey)
{
	uint8_t ret = 0;
	
	g_ubFileManagerGetKey[nNum] = ubKey;
